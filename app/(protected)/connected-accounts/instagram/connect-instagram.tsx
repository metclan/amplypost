...
export default function InstagramCallback() {
    ...
    useEffect(() => {
        ...
        async function connectInstagram() {
            if (!code) {
                setState("error");
                setMessage("No authorization code was received from Instagram.");
                return;
            }
    ...
    if (error) {
        ...
        return (
            <StatusPanel
                ...
                message={
                    isUserCancelled
                        ? "You cancelled the Instagram connection request. You can try again whenever you are ready."
                        : errorDescription || "Instagram returned an error before the account could be connected."
                }
            />
        );
    }
