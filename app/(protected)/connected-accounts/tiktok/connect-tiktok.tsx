...
export default function TikTokCallback() {
    ...
    const code = rawCode ? rawCode.split("&")[0].split("?")[0] : null;
    ...
    useEffect(() => {
        ...
        async function connectTikTok() {
            if (!code) {
                setState("error");
                setMessage("No authorization code was received from TikTok.");
                return;
            }
            ...
            try {
                ...
                setState("error");
                setMessage("We could not connect your TikTok account.");
    ...
    if (error) {
        ...
        return (
            <StatusPanel
                ...
                message={
                    isUserCancelled
                        ? "You cancelled the TikTok connection request. You can try again whenever you are ready."
                        : errorDescription || "TikTok returned an error before the account could be connected."
                }
            />
        );
    }
